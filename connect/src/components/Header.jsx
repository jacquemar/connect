    ...
    <div>
      <nav className="fixed top-0 left-0 right-0 flex justify-between items-center mt-4 p-4 font-sans font-bold w-full z-50">
        ...
        <div className="hidden md:flex mx-20 items-center justify-between flex-grow">
          ...
          <button className="flex-grow text-center w-1/3 mx-2 px-4 py-2 bg-[#8DC63F] text-white rounded-full">
            Se connecter
          </button>
          <div className="ml-4">
            <img src={profilIcon} alt="Profile" className="h-auto w-28 rounded-full" />
          </div>
        </div>
